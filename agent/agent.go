...
// Agent is the public interface for driving the agent loop.
type Agent interface {
	// Run executes the agent loop given an initial user prompt and returns
	// the final assistant response (or an error).
